      ...
      <Wrapper>
        <main>
          ...
          <div className="container">
            ...
            >
              <div className="img">
                <img src="https://play-lh.googleusercontent.com/15OKLti0ofnjK4XK1bgRXgsoblPvMi3hCA5z2o9WAcjssFNt2dXxemp2Om9vB3A_jYAe" alt="" loading="lazy"/>
              </div>
              <div className="info">
                <h3>Michel</h3>
            ...
            >
              <div className="img">
                <img src="https://i.pinimg.com/564x/d8/26/5f/d8265f7a1c2937b9f4591bfed45db69d.jpg" alt="" loading="lazy" />
              </div>
              <div className="info">
                <h3>Drake</h3>
            ...
            >
              <div className="img">
                <img src="https://wallpapers.com/images/thumbnail/cute-sung-jin-woo-and-adorable-kamish-4ytyk7qcfmj5tuib.webp" alt="" loading="lazy"/>
              </div>
              <div className="info">
                <h3>Sung jin woo</h3>
